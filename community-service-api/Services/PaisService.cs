...
public interface IPaisService
{
    ...
    Task<PaisDto> CreateAsync(PaisCreateDto dto);
    Task<bool> UpdateAsync(int id, PaisUpdateDto dto);
...
public class PaisService : IPaisService
{
    ...
    public async Task<PaisDto> CreateAsync(PaisCreateDto dto)
    {
    ...
    public async Task<bool> UpdateAsync(int id, PaisUpdateDto dto)
    {
        var entity = await _repository.GetByIdAsync(id);
        if (entity is null)
        {
