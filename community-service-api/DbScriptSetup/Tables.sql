...
CREATE SEQUENCE SEQ_CORREO_PENDIENTE START WITH 1 INCREMENT BY 1 NOCACHE;
...
(
  ...
  CONSTRAINT CK_USUARIO_F_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_TIPO_CORRESP_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_CORRESP_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_TIPO_IDENT_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_PAIS_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_PROVINCIA_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_CANTON_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_DISTRITO_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_UBIC_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_UNIVERSIDAD_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_PERFIL_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_ORG_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_ROL_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_RUO_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_CAT_ACT_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_ACT_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_COORD_ACT_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_HOR_ACT_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_PART_ACT_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
  ...
  CONSTRAINT CK_CERT_PART_VIG CHECK (FECHA_HASTA IS NULL OR FECHA_DESDE <= FECHA_HASTA),
...
(
    ID_CORREO_PENDIENTE  NUMBER(10) DEFAULT SEQ_CORREO_PENDIENTE.NEXTVAL NOT NULL,
    DESTINATARIO         VARCHAR2(255)                                   NOT NULL,
    ASUNTO               VARCHAR2(500)                                   NOT NULL,
    CUERPO               CLOB                                            NOT NULL,
    ADJUNTO              BLOB                                            NULL,
    NOMBRE_ADJUNTO       VARCHAR2(255)                                   NULL,
    ID_USUARIO           NUMBER(10)                                      NOT NULL,
    ID_CERTIFICACION     RAW(16)                                         NULL,
    ESTADO               VARCHAR2(50)   DEFAULT 'P'                      NOT NULL,
    INTENTOS             NUMBER(10)     DEFAULT 0                        NOT NULL,
    FECHA_CREACION       DATE           DEFAULT SYSDATE                  NOT NULL,
    FECHA_ULTIMO_INTENTO DATE                                            NULL,
    MENSAJE_ERROR        VARCHAR2(4000)                                  NULL,
    CONSTRAINT PK_CORREO_PENDIENTE PRIMARY KEY (ID_CORREO_PENDIENTE),
    CONSTRAINT CK_CORREO_PENDIENTE_ESTADO CHECK (ESTADO IN ('P', 'E', 'F')),
