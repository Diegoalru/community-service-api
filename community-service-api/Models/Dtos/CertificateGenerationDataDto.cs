...
/// <summary>
/// DTO that combines all necessary data for generating a certificate PDF and enqueuing the email.
/// It matches the output of the modified PKG_CERTIFICADO_PARTICIPACION.P_OBTENER_DATOS_PDF procedure.
/// </summary>
public class CertificateGenerationDataDto
{
    ...
    public int IdUsuarioVoluntario { get; set; } // Added as per requirement
